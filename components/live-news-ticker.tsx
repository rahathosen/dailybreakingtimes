...
import { AlertCircle,Expand, Radio, Pause, Play, Volume2, VolumeX } from "lucide-react"
...
export function LiveNewsTicker() {
  ...
  // Show ticker when breaking news section is out of view
  useEffect(() => {
    const handleScroll = () => {
      // Show the ticker when user has scrolled past 300px
  ...
  // Simulate receiving new breaking news
  useEffect(() => {
      ...
      <div className="container mx-auto h-full">
        ...
        <div className="h-12 flex items-center justify-between px-4">
          ...
          <div className="flex-1 mx-4 overflow-hidden">
            <div className="whitespace-nowrap overflow-hidden text-ellipsis">
              <span className="text-sm font-medium">{currentNews.category}: </span>
        ...
        {isExpanded && (
          <div className="h-[calc(300px-3rem)] overflow-y-auto p-4">
            <h3 className="font-serif text-xl font-bold mb-4">Live News Updates</h3>
              ...
              {news.map((item) => (
                <div
                  ...
                  className={cn(
                    ...
                    item.isBreaking ? "bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800" : "",
                    currentIndex === news.findIndex((n) => n.id === item.id) ? "ring-2 ring-primary" : "",
                  )}
                >
