...
import { LayoutDashboard, Newspaper, Tag, ListFilter, FileText, Vote, Home, X } from "lucide-react"
            ...
            {navItems.map((item) => (
              ...
              >
                <Button
                  ...
                  className={cn("w-full justify-start", pathname === item.href ? "bg-secondary font-medium" : "")}
                >
