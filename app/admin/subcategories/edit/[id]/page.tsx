  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setSlug(subcategoryData.slug);
        setCategoryId(subcategoryData.categoryId.toString());
        setShowInHeader(subcategoryData.show_in_header);
        setIsHighlighted(subcategoryData.is_highlighted);
      } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Update an existing subcategory</p>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Edit the details for this subcategory
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? "Saving..." : "Update Subcategory"}
            </Button>
          </CardFooter>
        </form>
      </Card>
